export default {
    ...
    actions: {
        ...
        findList(context, par) {
            ...
            global
                ...
                .then(res => {
                    ...
                    _curd.table.columns = [
                        {DataIndex:'Function_Num',Title:'功能编号',Show:true},
                        {DataIndex:'Function_Name',Title:'功能名称',Show:true},
                        {DataIndex:'Function_ByName',Title:'权限编码',Show:true},
                        {DataIndex:'Function_CreateTime',Title:'创建时间',Show:true},
        ...
        save(context, par) {
            ...
            var _vm = _form.vm;
            //验证数据
            if (!_vm.Model.Function_Name) return global.tools.msg('角色名称不能为空!', '错误');
            //发送请求给接口
            global
