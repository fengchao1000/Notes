export default {
    ...
    actions: {
            ...
            global
                ...
                .then(res => {
                    ...
                    _curd.table.columns =[
                        ...
                        {DataIndex:'LotName',Title:'彩票名称',Show:true},
                        {DataIndex:'DataTableName',Title:'数据表名称',Show:true},
                        {DataIndex:'CateName',Title:'分类名称',Show:true},
                        {DataIndex:'LTypeName',Title:'类型名称',Show:true},
                        {DataIndex:'BallDisplayType',Title:'球号类型',Show:true},
                        {DataIndex:'IsHot',Title:'是否为热门',Show:true},
        ...
        loadForm(context, par) {
            ...
            global
                ...
                .then(res => {
                    ...
                    {
                         _curd.form.vm.Id = 0;
                         _curd.form.vm.Model.CateID="";
                         _curd.form.vm.Model.LTypeID="";
                    }
        ...
        save(context, par) {
            ...
            var _vm = _form.vm;
            //验证数据
            if (!_vm.Model.LotName) return global.tools.msg('请输入彩票类型!', '错误');
            if (!_vm.Model.DataTableName) return global.tools.msg('请输入数据表名!', '错误');
            if (!_vm.Model.CateID) return global.tools.msg('请选择分类!', '错误');
            if (!_vm.Model.LTypeID) return global.tools.msg('请选择类型!', '错误');
            if (!_vm.Model.BallDisplayType) return global.tools.msg('请选择球号类型!', '错误');
