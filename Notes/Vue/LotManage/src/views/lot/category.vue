            ...
            <a-row :gutter="20">
              <a-col >
                <a-form-item label="分类名称">
                  <a-input v-model="curd.form.vm.Model.CateName" placeholder="分类名称" />
                </a-form-item>
              </a-col>
            </a-row>
            <a-row :gutter="20">
              <a-col >
                <a-form-item label="样式名称">
                  <a-input v-model="curd.form.vm.Model.ClassName" placeholder="样式名称" />
                </a-form-item>
              </a-col>
            </a-row>
            <a-row :gutter="20">
              <a-col >
                <a-form-item label="开奖GIF">
                  <a-input v-model="curd.form.vm.Model.GifName" placeholder="GifName" />
                </a-form-item>
              </a-col>
            </a-row>
             <a-row :gutter="20">
              <a-col >
                <a-form-item label="描述">
                  <a-input v-model="curd.form.vm.Model.CateDesc" placeholder="描述" />
                </a-form-item>
              </a-col>
            </a-row>
             <a-row :gutter="20">
