...
namespace Idsvr4
{
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            ...
            {
                //new ApiResource("FrameworkAPI",new List<string>(){JwtClaimTypes.Subject,JwtClaimTypes.Audience}),
                //new ApiResource("NetCoreAPI",new List<string>(){JwtClaimTypes.Subject,JwtClaimTypes.Audience})

                 new ApiResource("FrameworkAPI", "Demo API")
                 { 
                    Scopes = { "FrameworkAPI"}
                 },
            }; 
